import {
  SiReact, SiNextdotjs, SiThreedotjs, SiJavascript, SiNodedotjs, SiExpress,
  SiPython, SiSpringboot, SiDocker, SiKubernetes, SiGooglecloud, SiFirebase,
  SiMongodb, SiPostgresql, SiMysql, SiGit, SiTensorflow, SiJupyter, SiFramer,
  SiFastapi, SiTypescript, SiAppwrite, SiPytorch, SiCloudinary,
  SiAmazonwebservices, SiGooglegemini,
  SiTailwindcss
} from "react-icons/si";
import { DiDjango, DiJava, DiLaravel, DiPhp } from "react-icons/di";
...
export const techStack = [
  ...
  { icon: <SiTailwindcss color="#326CE5" />, name: "TailwindCSS" },
